...
MONGO_URI = 'mongodb+srv://luminiaruni:Sn9Pg5G6sQ6cPvKI@cluster0.0zku6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'  # Получи URI из MongoDB Atlas
